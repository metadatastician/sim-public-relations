...
= Contributing — PR Practice Lab
:revdate: 2026-MM-DD

== Audience

Developers working *on* `PR Practice Lab`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:metadatastician/PR Practice Lab.git
cd PR Practice Lab
...
* Bugs in `PR Practice Lab`: file at `metadatastician/PR Practice Lab/issues`.
