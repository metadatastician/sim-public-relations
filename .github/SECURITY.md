...
1. Navigate to [Report a Vulnerability](https://github.com/metadatastician/sim-public-relations/security/advisories/new)
...
- This repository (`metadatastician/sim-public-relations`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/metadatastician/sim-public-relations/security/advisories)
...
When using PR Practice Lab, we recommend:
...
- [Security Advisories](https://github.com/metadatastician/sim-public-relations/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/metadatastician/sim-public-relations/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/metadatastician/sim-public-relations/discussions) |
...
*Thank you for helping keep PR Practice Lab and its users safe.* 🛡️
