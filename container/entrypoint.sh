...
# PR Practice Lab container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping pr-practice-lab..."
...
# Examples:
#   exec /app/pr-practice-lab
#   exec /app/release/bin/pr-practice-lab start
#   exec /app/pr-practice-lab serve --host "${APP_HOST}" --port "${APP_PORT}"
