...
#
# PR Practice Lab — Cerro Torre build, sign, and verify pipeline
#
...
#   CT_KEY_ID       — Signing key identifier (default: pr-practice-lab-release)
