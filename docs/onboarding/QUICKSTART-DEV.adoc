...
// Replace rsr-template-repo, zig build, just test, Zig 0.16, Shell, A2ML and AsciiDoc with actuals
...
Zig 0.16, Shell, A2ML and AsciiDoc
...
fictional-only claims, hidden-reality isolation, deterministic replay and evidence-linked decisions
