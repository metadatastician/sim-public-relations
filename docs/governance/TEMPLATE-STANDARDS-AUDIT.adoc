...
| `README.adoc`
| Repository badges rendered with the real owner and repository name
| resolved
| The product README is initialised and contains no minting tokens.
| Keep the placeholder gate green.
